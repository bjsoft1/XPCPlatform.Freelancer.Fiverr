...
public class XPCPlatformPermissionDefinitionProvider : PermissionDefinitionProvider
{
    ...
    {
        var permissionGroup = context.AddGroup(XPCPlatformPermissions.GroupName);
        //Define your own permissions here. Example:
        //myGroup.AddPermission(XPCPlatformPermissions.MyPermission1, L("Permission:MyPermission1"));

        #region Admin permission
        var adminPermission = permissionGroup.AddPermission(XPCPlatformPermissions.AdminAccounts.Default, L($"Permission:{XPCPlatformPermissions.AdminAccounts.Default}"));
